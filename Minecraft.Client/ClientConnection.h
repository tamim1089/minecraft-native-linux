...
private:
	...
	// I don't think we are interested in the PlayerInfo data, so I'm not going to use it at the moment
...
public:
	...
	static int HostDisconnectReturned(void *pParam,int iPad,CStorage::EMessageResult result);
