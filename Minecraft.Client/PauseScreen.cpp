...
void PauseScreen::buttonClicked(Button button)
{
 ...
 //       minecraft->grabMouse();		// removed
    }

    if (button.id == 5)
	{
//        minecraft->setScreen(new AchievementScreen(minecraft->stats));	// put back
    }
    if (button.id == 6)
	{
//        minecraft->setScreen(new StatsScreen(this, minecraft->stats));	// put back
    }
}
