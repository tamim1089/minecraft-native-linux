...
void CreateWorldScreen::init()
{
    ...
    nameEdit = new EditBox(this, font, width / 2 - 100, 60, 200, 20, language->getElement(L"testWorld")); // test - should be L"selectWorld.newWorld"
...
{
	wstring folder2 = folder;	// copy input as it is const
...
// This screen is not used, so removing this to stop the build failing
#if 0
