...
private:
//	final DateFormat DATE_FORMAT = new SimpleDateFormat();		// removed
...
public:
	...
	public:
		...
		// had to add input parameters to ctor, original is a java subclass of the screen and can access its members
