...
private:
	...
	private:
        ...
        double cullOffs;
	public:
		Face() {}	// added so we can declare an array of these (unitialised) in the class
...
private:
	double _max(double a, double b, double c);		// renamed from _max due to #define conflict in stdlib
public:
