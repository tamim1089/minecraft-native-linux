...
{
	// original version used generics and thus had an input parameter of type MushroomCow rather than shared_ptr<Entity>  we have here - 
	// do some casting around instead
	//shared_ptr<MushroomCow> mob = dynamic_pointer_cast<MushroomCow>(_mob);

	// No need to do the cast, just pass through as-is
	MobRenderer::render(_mob, x, y, z, rot, a);
}

void MushroomCowRenderer::additionalRendering(shared_ptr<Mob> _mob, float a)
{
	// original version used generics and thus had an input parameter of type MushroomCow rather than shared_ptr<Mob>  we have here - 
	// do some casting around instead
	shared_ptr<MushroomCow> mob = dynamic_pointer_cast<MushroomCow>(_mob);
