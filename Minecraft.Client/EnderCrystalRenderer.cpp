...
{
	// original version used generics and thus had an input parameter of type EnderCrystal rather than shared_ptr<Entity>  we have here - 
	...
	bindTexture(TN_MOB_ENDERDRAGON_ENDERCRYSTAL); //  "/mob/enderdragon/crystal.png"
