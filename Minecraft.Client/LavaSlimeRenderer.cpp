...
{		
	// original version used generics and thus had an input parameter of type LavaSlime rather than shared_ptr<Entity>  we have here - 
	...
	if (modelVersion != this->modelVersion)
	{
		...
		app.DebugPrintf("new lava slime model/n");
	}
...
{
	// original version used generics and thus had an input parameter of type LavaSlime rather than shared_ptr<Mob>  we have here - 
	// do some casting around instead
