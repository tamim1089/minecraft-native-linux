...
void HugeExplosionParticle::render(Tesselator *t, float a, float xa, float ya, float za, float xa2, float za2)
{
	...
	if (tex > 15) return;
	textures->bindTexture(TN_MISC_EXPLOSION); //  "/misc/explosion.png"
	...
	// don't render explosion particles that are less than 3 metres away, to try and avoid large particles that are causing us problems with photosensitivity testing
