...
void EntityTracker::addEntity(shared_ptr<Entity> e)
{
	...
	else if (e->GetType() == eTYPE_DRAGON_FIREBALL) addEntity(e, 16 * 4, 10, false); //  TU9
...
// have split removeEntity into two bits - it used to do the equivalent of EntityTracker::removePlayer followed by EntityTracker::removeEntity.
...
void EntityTracker::tick()
{
	...
	// If one player on a system is updated, then make sure they all are as they all have their
	...
	// We want to do this for dead players as they don't tick normally
