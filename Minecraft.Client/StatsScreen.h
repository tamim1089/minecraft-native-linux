...
public:
	...
	protected:
		StatsScreen *parent;
	public:
		GeneralStatisticsList(StatsScreen *ss);	// added parameter so we can access parent
...
//        Comparator<ItemStat> itemStatSorter;
        ...
        int sortOrder;
	public:
        StatisticsList(StatsScreen *ss);	// added parameter so we can access parent
        virtual void selectItem(int item, bool doubleClick);
        virtual bool isSelectedItem(int item);
        virtual void renderBackground();
...
public:
	...
	public:
		ItemStatisticsList(StatsScreen *ss);	// added parameter so we can access parent
		virtual void renderHeader(int x, int y, Tesselator *t);
        virtual void renderItem(int i, int x, int y, int h, Tesselator *t);
	...
	public:
		BlockStatisticsList(StatsScreen *ss);	// added parameter so we can access parent
		virtual void renderHeader(int x, int y, Tesselator *t);
        virtual void renderItem(int i, int x, int y, int h, Tesselator *t);
        virtual wstring getHeaderDescriptionId(int column);
	};
