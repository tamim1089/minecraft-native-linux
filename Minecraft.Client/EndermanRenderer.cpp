...
{
	// original version used generics and thus had an input parameter of type Boat rather than shared_ptr<Entity>  we have here - 
...
int EndermanRenderer::prepareArmor(shared_ptr<Mob> _mob, int layer, float a)
{
	...
	bindTexture(TN_MOB_ENDERMAN_EYES);	//  L"/mob/enderman_eyes.png"
	float br = 1;
	glEnable(GL_BLEND);
