...
{
private:
	static const int MAX_PARTICLES_PER_LAYER = 200;		// reduced from 4000
...
protected:
	Level *level;
private:
	deque<shared_ptr<Particle> > particles[3][TEXTURE_COUNT];		//  two arrays to cope with simultaneous two dimensions
    Textures *textures;
    Random *random;
