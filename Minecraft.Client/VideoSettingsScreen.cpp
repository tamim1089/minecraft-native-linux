...
{
	this->title = L"Video Settings"; // added
...
void VideoSettingsScreen::init()
{
	...
	// this was as static array but moving it into the function to remove any issues with static initialisation order
...
void VideoSettingsScreen::buttonClicked(Button *button)
{
    ...
    Screen::init(minecraft, screenWidth, screenHeight);	// was this.init
}
