...
private:
    ...
    bool hasNormal;
    int p ;
	bool	useCompactFormat360; // added
	bool	useProjectedTexturePixelShader;	// added
public:
    int count;
private:
    bool _noColor;
	...
	// added for thread local storage
public:
...
private:
	...
	// added to handle compact quad vertex format, which need packaged up as quads
...
public:
	...
	// added, to calculate tight bounds
	class Bounds
	{
	public:
		void reset()
	...
	void tex2(int tex2);	// change brought forward from 1.8.2
