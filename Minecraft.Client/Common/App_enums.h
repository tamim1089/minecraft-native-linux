...
// 	eTMSAction_TMSPP_ConfigFile_Waiting,
	...
	eTMSAction_TMSPP_UIDSFile,
	eTMSAction_TMSPP_UIDSFile_Waiting,
...
enum eXuiServerAction
{
	...
	eXuiServerAction_ServerSettingChanged_Usernames,
...
enum eGameSetting
{
	...
	eGameSetting_UsernamesVisible,
	// Interim TU 1.6.6
	eGameSetting_Autosave,
	eGameSetting_DisplaySplitscreenUsernames,
	eGameSetting_Hints,
	...
	eGameSetting_Linux_NetworkModeAdhoc,
...
// Whend adding new options you should consider whether having them on should disable achievements, and if so add them to the CanRecordStatsAndAchievements function
// These options are now saved in save data, so new options can ONLY be added to the end
...
// If any new DLC items are added to the TMSFiles, this array needs updated
#ifdef _LINUX
enum _TMSFILES
{
	TMS_SP1=0,
