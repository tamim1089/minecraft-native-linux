...
HRESULT UIScene_PauseMenu::OnNotifyPressEx(HXUIOBJ hObjPressed, XUINotifyPress* pNotifyPressData, BOOL& rfHandled)
{
	...
	//if(pNotifyPressData->UserIndex!=pMinecraft->player->GetPadIndex()) return S_OK;
	...
	case BUTTON_PAUSE_SAVEGAME:		
		{	
			...
			// does the save exist?
			bool bSaveExists;
			CStorage::ELoadGameStatus result=StorageManager.DoesSaveExist(&bSaveExists);
...
int UIScene_PauseMenu::BanGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	...
	{
		// Only do this if we are currently idle, don't want the (relatively) low priority ban task overriding something else
...
int UIScene_PauseMenu::DeviceRemovedDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
int UIScene_PauseMenu::ExitGameDeclineSaveReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
...
int UIScene_PauseMenu::ExitGameAndSaveReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
int UIScene_PauseMenu::SaveGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
...
int UIScene_PauseMenu::ExitGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
