...
HRESULT CScene_Intro::OnInit( XUIMessageInit* pInitData, BOOL& bHandled )
{
	...
	// We can't check to see if the version is a trial or full game until after 5 seconds...
...
HRESULT CScene_Intro::OnTimelineEnd(HXUIOBJ hObjSource, BOOL& bHandled)
{
	...
	else
	{
		...
		case TIMELINE_NORMAL:
			{	
				// lots of discussions over this because Brazil is in the NA region. This is what I have been advised to do...
