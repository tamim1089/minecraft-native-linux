...
protected:
	...
	XUI_END_MSG_MAP()
		...
		static int ConfirmLoadReturned(void *pParam,int iPad,CStorage::EMessageResult result);
		...
		static int CheckResetNetherReturned(void *pParam,int iPad,CStorage::EMessageResult result);
...
private:
	static int UnlockTexturePackReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	...
	DWORD m_dwSaveFileC;
#ifdef _LINUX
	CStorage::CACHEINFOSTRUCT *m_InfoA;
#endif
