...
HRESULT CXuiCtrlEnchantmentBook::OnRender(XUIMessageRender *pRenderData, BOOL &bHandled )
{
	...
	int tex = pMinecraft->textures->loadTexture(TN_ITEM_BOOK); //  L"/1_2_2/item/book.png"
...
//	// Inputs in the java, dunno what they are.
//	float a = 1;
//	D3DXMATRIX matrix;
...
//	// Trying to position it within the XUI element
//	float xPos, yPos;
...
//    glScalef(ss, ss, ss);
//    glRotatef(180, 0, 0, 1);
//	int tex = minecraft->textures->loadTexture(TN_ITEM_BOOK); //  L"/1_2_2/item/book.png"
