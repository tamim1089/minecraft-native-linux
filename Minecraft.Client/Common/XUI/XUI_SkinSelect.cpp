...
HRESULT CScene_SkinSelect::OnInit( XUIMessageInit* pInitData, BOOL& bHandled )
{
	...
	// Added this so that we have skins loaded
...
HRESULT CScene_SkinSelect::OnKeyDown(XUIMessageInput* pInputData, BOOL& rfHandled)
{
	...
	// We don't want the press anim to play for the scrolling unless we are actually scrolling
...
int CScene_SkinSelect::UnlockSkinReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
