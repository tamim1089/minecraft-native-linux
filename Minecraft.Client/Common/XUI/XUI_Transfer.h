...
#include "../Media/xuiscene_Transfer.h"


class CXuiCtrl4JList;

class CScene_Transfer : public CXuiSceneImpl
{
protected:
...
public:
	...
	XUI_IMPLEMENT_CLASS( CScene_Transfer, L"CScene_Transfer", XUI_CLASS_SCENE )

	static int TMSPPSlotListReturned(LPVOID pParam,int iPad,int iUserData,CStorage::PTMSPP_FILEDATA pFileData, LPCSTR szFilename);
