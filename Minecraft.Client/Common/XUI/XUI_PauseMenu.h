...
public:
	...
	static int BanGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	static int DeviceSelectReturned(void *pParam,bool bContinue);
	static int DeviceRemovedDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
