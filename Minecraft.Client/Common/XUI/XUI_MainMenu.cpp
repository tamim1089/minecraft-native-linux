...
HRESULT CScene_Main::OnTransitionStart( XUIMessageTransition *pTransition, BOOL& bHandled )
{
	...
	{
		// remove the "hobo humping" message legal (Sony) say we can't have - pretty sure Microsoft would say the same if they noticed it.
		...
		// Going to resize buttons if the text is too big to fit on any of them (Br-pt problem with the length of Unlock Full Game)
...
int CScene_Main::MustSignInReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::ExitGameReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	//CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::TMSReadFileListReturned(void *pParam,int iPad,CStorage::PTMSPP_FILE_LIST pTmsFileList)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::TMSFileReadReturned(void *pParam,int iPad,CStorage::PTMSPP_FILEDATA pData)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
