...
protected:
		...
		CXuiControl m_difficulty, m_GameType, m_usernamesOn, m_structuresOn, m_levelType, m_pvpOn, m_trustPlayers, m_tntOn, m_fireOn;
		CXuiControl m_labelDifficulty, m_labelGameType, m_labelUsernamesOn, m_labelStructuresOn, m_labelLevelType, m_labelPvP, m_labelTrust, m_labelTNTOn, m_labelFireOn;
	...
	BEGIN_CONTROL_MAP()
		...
		BEGIN_MAP_CHILD_CONTROLS(m_GameSettingsGroup)
			MAP_CONTROL(IDC_UsernamesOn, m_usernamesOn)
			...
			MAP_CONTROL(IDC_LabelUsernamesOn, m_labelUsernamesOn)
