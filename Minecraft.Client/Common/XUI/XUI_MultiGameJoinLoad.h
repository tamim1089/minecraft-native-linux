...
private:
	...
	// callback
#ifdef _LINUX
	static bool GetSavesInfoCallback(LPVOID pParam,int iInstalledC, CStorage::CACHEINFOSTRUCT *InfoA, int iPad, HRESULT hRes);
#else
	...
	static int UploadSaveThreadProc( LPVOID lpParameter );
