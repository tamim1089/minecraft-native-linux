...
#define XUI_BASE_SPLITSCREEN_SCALE 1.0f//0.5f // TODO - move scenes instead
...
protected:
	...
	HXUIOBJ m_hUsernameA[XUSER_MAX_COUNT];
...
private:
	...
	HRESULT						_ShowSavingMessage( unsigned int iPad, CStorage::ESavingMessage eVal );
	...
	HRESULT						_DisplayUsername( unsigned int iPad, BOOL bDisplay );
...
public:
	...
	static HRESULT				ShowSavingMessage( unsigned int iPad, CStorage::ESavingMessage eVal);
	...
	static HRESULT				DisplayUsername( unsigned int iPad, BOOL bDisplay );
