...
HRESULT CScene_DLCOffers::OnInit( XUIMessageInit* pInitData, BOOL& bHandled )
{
	...
	// Deleting this here seems simpler.
	delete param;
...
// int CScene_DLCOffers::EthernetDisconnectReturned(void *pParam,int iPad,const CStorage::EMessageResult)
// {
