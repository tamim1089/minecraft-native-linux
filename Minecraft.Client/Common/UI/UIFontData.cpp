...
SFontData SFontData::GameFont_7
	= {

		/* Font Name */		"GameFont7",

#ifdef _LINUX
		/* filename */		L"/font/GameFont_7.png",
#else
		/* Filename */		L"/TitleUpdate/res/font/GameFont_7.png",
#endif
...
SFontData SFontData::GameFont_11
	= {

		/* Font Name */		"GameFont11",

#ifdef _LINUX 
		/* filename */		L"/font/GameFont_11.png",
#else
		/* Filename */		L"/TitleUpdate/res/font/GameFont_11.png",
#endif
	...
	: m_unicodeMap( sFontData.m_uiGlyphCount + 2 )
{
	...
	// Take the alpha channel from each pixel.
	...
	for (unsigned short glyph = 0; glyph < sFontData.m_uiGlyphCount; glyph++)
	{
		...
		// Empty glyphs are considered to be whitespace.
	...
	for (int i = 0; i < sFontData.m_uiGlyphCount; i++)
	{
		...
		if (i != getGlyphId(unicode))
		{
			...
			app.DebugPrintf( "<GLYPH_%03i> %i/t%c/tU+%.4X, kerning=%i, (%2i,%2i). %s/n", 
