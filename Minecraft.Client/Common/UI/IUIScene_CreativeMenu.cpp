...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
	...
	DEF(eCreativeInventory_Decoration)
		...
		// Already got sugar cane in Materials ITEM_11(Tile::reeds_Id)
		ITEM(Tile::web_Id)
	...
	DEF(eCreativeInventory_Materials)
		...
		// Anything else added here also needs to be added to the key handler below
		...
		DEF(eCreativeInventory_Potions_Extended)
			...
			//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_LEVEL2, MASK_INSTANTHEALTH))
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_NIGHTVISION))	// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_INVISIBILITY))	// Moved here as there isn't a weak variant of this potion.
			...
			//ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTHEALTH))
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_NIGHTVISION))		// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_INVISIBILITY))	// Moved here as there isn't a weak variant of this potion.
		...
		DEF(eCreativeInventory_Potions_Level2_Extended)
			...
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_NIGHTVISION))	// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_INVISIBILITY))	// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_WEAKNESS))
			...
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_NIGHTVISION))		// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_INVISIBILITY))	// Moved here as there isn't a weak variant of this potion.
			ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_WEAKNESS))
...
IUIScene_CreativeMenu::ItemPickerMenu::ItemPickerMenu(	shared_ptr<SimpleContainer> smp, shared_ptr<Inventory> inv ) : AbstractContainerMenu()
{
	...
	{
		// These values get set by addSlot anyway.
	...
	// Give the creative menu a unique container id
...
{
	// Make pressing the X button clear the hotbar
	if(buttonNum == 1)
	{
