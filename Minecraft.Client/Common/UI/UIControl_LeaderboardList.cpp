...
void UIControl_LeaderboardList::setupTitles(const wstring &rank, const wstring &username)
{
	IggyDataValue result;
	...
	stringVal1.string = (IggyUTF16*)username.c_str();
	stringVal1.length = username.length();
...
#ifdef _LINUX
	// add this button to the vita touch box list
...
void UIControl_LeaderboardList::addDataSet(bool bLast, int iId, int iRank, const wstring &username, bool bDisplayMessage, const wstring &col0, const wstring &col1, const wstring &col2, const wstring &col3, const wstring &col4, const wstring &col5, const wstring &col6)
{
	IggyDataValue result;
	...
	IggyStringUTF16 stringVal0;
	stringVal0.string = (IggyUTF16*)username.c_str();
	stringVal0.length = username.length();
