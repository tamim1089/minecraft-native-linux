...
UIScene_EndPoem::UIScene_EndPoem(int iPad, void *initData, UILayer *parentLayer) : UIScene(iPad, parentLayer)
{
	...
	// Don't need these, the AS handles the scrolling and makes it look nice
#if 0
	...
	// Iggy seems to strip our trailing linebreaks, so added a space to made sure it scrolls this far
	...
	// Find paragraph start and end points.
