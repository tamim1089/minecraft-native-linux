...
int IUIScene_PauseMenu::ExitGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
int IUIScene_PauseMenu::ExitGameSaveDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	IUIScene_PauseMenu *scene = (IUIScene_PauseMenu *)pParam;
...
int IUIScene_PauseMenu::ExitGameAndSaveReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// we won't come in here if we have a trial texture pack
	IUIScene_PauseMenu *scene = (IUIScene_PauseMenu *)pParam;
...
int IUIScene_PauseMenu::ExitGameDeclineSaveReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	IUIScene_PauseMenu *scene = (IUIScene_PauseMenu *)pParam;
...
int IUIScene_PauseMenu::WarningTrialTexturePackReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
void IUIScene_PauseMenu::_ExitWorld(LPVOID lpParameter)
{
	...
	if (pMinecraft->isClientSide() || g_NetworkManager.IsInSession())
	{
		if(lpParameter != NULL )
		{
			// check if we have lost connection to Live
			...
			UINT uiIDA[1];
			uiIDA[0]=IDS_CONFIRM_OK;
			// Fix for #48669 - TU5: Code: Compliance: TCR #15: Incorrect/misleading messages after signing out a profile during online game session.
		...
		//  need to do this in a QNet callback where it is safe
...
int IUIScene_PauseMenu::SaveGameDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
...
int IUIScene_PauseMenu::EnableAutosaveDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
...
int IUIScene_PauseMenu::DisableAutosaveDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorage::EMessage_ResultDecline) 
	{
