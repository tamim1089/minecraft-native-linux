...
// This class is for code that is common between XUI and Iggy
...
{
public:
	// These map directly to the tabs seenon the screen
	...
	// These are logical groupings of items, and be be combined for tabs on-screen
	...
	// Keeping all the tab specifications in one place.
	struct TabSpec
	{
	public:
		// Layout
