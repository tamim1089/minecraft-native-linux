...
// There was a request to be able to navigate the scenes with the dpad, so I have used much of the TAP_DETECTION
...
protected:
	...
	// Always make the Using section the first one
	enum ESceneSection
	{
		eSectionNone = -1,
	...
	// WESTY  - Added for pointer prototype.
