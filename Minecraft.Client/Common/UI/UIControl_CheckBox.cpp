...
#ifdef _LINUX
	// add checkbox to the vita touch box list
...
// this is only ever used when required, most of this should happen in the flash
...
//  we need to trigger this one via function instead of key down event because of how it works
