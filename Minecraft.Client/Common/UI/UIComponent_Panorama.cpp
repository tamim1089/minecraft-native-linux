...
void UIComponent_Panorama::render(S32 width, S32 height, CRender::eViewportType viewport)
{
	bool specialViewport =	(viewport == CRender::VIEWPORT_TYPE_SPLIT_TOP) ||
		(viewport == CRender::VIEWPORT_TYPE_SPLIT_BOTTOM) ||
		(viewport == CRender::VIEWPORT_TYPE_SPLIT_LEFT) ||
		(viewport == CRender::VIEWPORT_TYPE_SPLIT_RIGHT);
	if(m_bSplitscreen && specialViewport)
	{
		...
		if((viewport == CRender::VIEWPORT_TYPE_SPLIT_LEFT) ||	(viewport == CRender::VIEWPORT_TYPE_SPLIT_RIGHT))
		{
