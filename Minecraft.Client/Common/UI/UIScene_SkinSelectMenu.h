...
private:
	...
	// How many to show on each side of the main control
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		// These aren't really used a AS3 controls, but adding here means that they get ticked by the scene
...
private:
	...
	static int UnlockSkinReturned(void *pParam,int iPad,CStorage::EMessageResult result);
