#pragma once
// remove the inherits via dominance warnings
...
// Setup some defines for quickly mapping elements in the scene
...
public:
	...
	// RENDERING
	virtual void render(S32 width, S32 height, CRender::eViewportType viewpBort);
