...
{
	app.DebugPrintf("Pressed = %d, %d/n", (int)controlId, (int)childId);
...
int UIScene_InGameInfoMenu::KickPlayerReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
#if defined _LINUX || defined _LINUX
int UIScene_InGameInfoMenu::MustSignInReturnedPSN(void *pParam,int iPad,CStorage::EMessageResult result)
{
	...
	{
#ifdef _LINUX
		SQRNetworkManager::AttemptSignIn(&UIScene_InGameInfoMenu::ViewInvites_SignInReturned, pClass);
#else // _LINUX
		SQRNetworkManager_Vita::AttemptSignIn(&UIScene_InGameInfoMenu::ViewInvites_SignInReturned, pClass);
#endif
	}
