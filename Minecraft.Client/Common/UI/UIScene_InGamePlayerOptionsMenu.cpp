...
UIScene_InGamePlayerOptionsMenu::UIScene_InGamePlayerOptionsMenu(int iPad, void *_initData, UILayer *parentLayer) : UIScene(iPad, parentLayer)
{
	...
	{
		m_labelUsername.init(editingPlayer->GetDisplayName());
	}
...
int UIScene_InGamePlayerOptionsMenu::KickPlayerReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
