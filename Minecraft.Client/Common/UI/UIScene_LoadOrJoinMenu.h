...
public:
	...
	static int DeleteSaveDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	static int SaveOptionsDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
...
private:
	...
	typedef struct _SaveTransferStateContainer
	{
		...
		bool m_bSaveTransferCancelled;
		int m_iPad;
		CStorage::eSaveTransferState m_eSaveTransferState;
	...
	static CStorage::SAVETRANSFER_FILE_DETAILS m_debugTransferDetails;
#endif

	void LaunchSaveTransfer();
	static int DownloadSaveThreadProc( LPVOID lpParameter );
	...
	static int SaveTransferReturned(LPVOID lpParam,CStorage::SAVETRANSFER_FILE_DETAILS *pSaveTransferDetails);
	...
	static int NeedSyncMessageReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	...
	static int CrossSaveFinishedCallback(void *pParam,int iPad,CStorage::EMessageResult result);
	static int CrossSaveDeleteOnErrorReturned(LPVOID lpParam,bool bRes);
	static int RemoteSaveNotFoundCallback(void *pParam,int iPad,CStorage::EMessageResult result);
	...
	static int SaveTransferDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	static int CrossSaveUploadFinishedCallback(void *pParam,int iPad,CStorage::EMessageResult result);
#endif

#if defined _LINUX || defined _LINUX
	static int CopySaveDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result);
	static int CopySaveThreadProc( LPVOID lpParameter );
	static int CopySaveDataReturned( LPVOID lpParameter, bool success, CStorage::ESaveGameState state );
	static bool CopySaveDataProgress(LPVOID lpParam, int percent);
	static void CancelCopySaveCallback(LPVOID lpParam);
	static int CopySaveErrorDialogFinishedCallback(void *pParam,int iPad,CStorage::EMessageResult result);
#endif
};
