...
private:
	...
	UIControl_Label m_labelUsername;
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT( m_labelUsername, "username")
...
public:
	...
	static int KickPlayerReturned(void *pParam,int iPad,CStorage::EMessageResult result);
