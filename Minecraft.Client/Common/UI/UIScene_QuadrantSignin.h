...
private:
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_BEGIN_MAP_CHILD_ELEMENTS(m_controlPanels[0])
			...
			UI_MAP_ELEMENT(m_labelDisplayName[0], "username")
		...
		UI_BEGIN_MAP_CHILD_ELEMENTS(m_controlPanels[1])
			...
			UI_MAP_ELEMENT(m_labelDisplayName[1], "username")
		...
		UI_BEGIN_MAP_CHILD_ELEMENTS(m_controlPanels[2])
			...
			UI_MAP_ELEMENT(m_labelDisplayName[2], "username")
		...
		UI_BEGIN_MAP_CHILD_ELEMENTS(m_controlPanels[3])
			...
			UI_MAP_ELEMENT(m_labelDisplayName[3], "username")
