...
{
	{ L"THE STUDIO",										NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eExtraLargeText },
	...
	{ L"",												NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eSmallText },	// extra blank line
	{ L"%ls",											IDS_CREDITS_RESTOFTEAM,		NO_TRANSLATED_STRING,eMediumText },																						
...
#ifdef _LINUX
// Aaron didn't want to be in the credits	{ L"Aaron Puzey",									NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eSmallText },
...
// font credits
	...
	{ L"",												NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eSmallText },	// extra blank line
	{ L"",												NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eSmallText },	// extra blank line
	{ L"Linux LIVE Arcade Team",							NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eExtraLargeText },
	{ L"",												NO_TRANSLATED_STRING,			NO_TRANSLATED_STRING,eSmallText },	// extra blank line																						
...
void UIScene_Credits::tick()
{
	...
	if(m_bAddNextLabel)
	{
		...
		{
			app.DebugPrintf("DLC credit %d/n",m_iCurrDefIndex-MAX_CREDIT_STRINGS);
			// DLC credit
		...
		// Set up the new text element.
		if(pDef->m_Text!=NULL) // think the RAD logo ones aren't set up yet and are coming is as null
		{	
...
{
	//app.DebugPrintf("UIScene_DebugOverlay handling input for pad %d, key %d, down- %ls, pressed- %ls, released- %ls/n", iPad, key, down?"TRUE":"FALSE", pressed?"TRUE":"FALSE", released?"TRUE":"FALSE");
