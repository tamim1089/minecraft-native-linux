...
protected:
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT(m_labelDisplayName,"LabelUsername")
		...
		UI_MAP_NAME(m_funcSetDisplayName, L"SetUsername")
...
public:
	...
	// RENDERING
	virtual void render(S32 width, S32 height, CRender::eViewportType viewport);
