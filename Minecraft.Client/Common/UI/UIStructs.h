...
// Structs shared by Iggy and Xui scenes.
...
typedef struct _MessageBoxInfo
{
	...
	UINT uiOptionC;
	DWORD dwPad;
	int( *Func)(LPVOID,int,const CStorage::EMessageResult);
	LPVOID lpParam;
	//CStringTable *pStringTable; // We don't need this for our internal message boxes
