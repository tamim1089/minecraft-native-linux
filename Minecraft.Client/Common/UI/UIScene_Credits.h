...
#define LINUX_CREDITS_COUNT 77
#define PS4_CREDITS_COUNT 75
#define LINUX_CREDITS_COUNT (75+318)
...
#elif defined(_LINUX) || defined __LP64__ || defined(_LINUX)
#define MAX_CREDIT_STRINGS (LINUX_CREDITS_COUNT + MILES_AND_IGGY_CREDITS_COUNT)
#elif defined(_LINUX)
#define MAX_CREDIT_STRINGS (LINUX_CREDITS_COUNT + MILES_AND_IGGY_CREDITS_COUNT + DYNAMODE_FONT_CREDITS_COUNT)
#endif
