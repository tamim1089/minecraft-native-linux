...
public:
	...
	void setupTitles(const wstring &rank, const wstring &username);
	void initLeaderboard(int iFirstFocus, int iTotalEntries, int iNumColumns);
	void setColumnIcon(int iColumn, int iType);
	void addDataSet(bool bLast, int iId, int iRank, const wstring &username, bool bDisplayMessage, const wstring &col0, const wstring &col1, const wstring &col2, const wstring &col3, const wstring &col4, const wstring &col5, const wstring &col6);
