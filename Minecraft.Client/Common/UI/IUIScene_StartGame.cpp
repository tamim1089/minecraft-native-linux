...
int IUIScene_StartGame::TrialTexturePackWarningReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
...
int IUIScene_StartGame::UnlockTexturePackReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
	IUIScene_StartGame* pScene = (IUIScene_StartGame*)pParam;
...
int IUIScene_StartGame::TexturePackDialogReturned(void *pParam,int iPad,CStorage::EMessageResult result)
{
