	...
	: Tutorial(iPad, true)
{
	...
	*/	
	...
	// Remove this string as it refers to things that don't exist in the current tutorial world!
...
// All tutorials are onby default in the full tutorial whether the player has previously completed them or not
