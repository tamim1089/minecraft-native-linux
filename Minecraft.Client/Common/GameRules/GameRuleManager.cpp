...
void GameRuleManager::loadGameRules(LevelGenerationOptions *lgo, byte *dIn, UINT dSize)
{
	...
	// I don't believe that the path-name is ever used.
...
#endif
			// DecompressLZXRLE uses the correct platform specific compression type. (need to assert that the data is compressed with it though).
