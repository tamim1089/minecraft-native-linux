...
bool LevelGenerationOptions::checkIntersects(int x0, int y0, int z0, int x1, int y1, int z1)
{
	...
	// We DO NOT intersect if our upper bound is below the lower bound for all schematics
...
{
	// We don't want to delete them when done, but probably want to keep a set of active schematics for the current world
	//AUTO_VAR(it, m_schematics.find(filename));
	//if(it != m_schematics.end())
	//{
