...
#undef __in
#undef __out
#include "../../Linux/Miles/include/mss.h"
#elif defined (_LINUX)
#include "../../Linux/Miles/include/mss.h"
#elif defined _LINUX
// Temp define to get Miles to link, can likely be removed when we get a new version of Miles
#define _SEKRIT
#include "../../Linux/Miles/include/mss.h"
#elif defined _LINUX
#include "../../Linux64/Miles/include/mss.h"
// Temp define to get Miles to link, can likely be removed when we get a new version of Miles
#define _SEKRIT2
#include "../../Linux/Miles/include/mss.h"
#endif
