...
public:
	...
	vector<Texture *> *createTextures(const wstring &filename, bool mipmap); //  mipmap param
...
public:
	...
	Texture *createTexture(const wstring &name, int mode, int width, int height, int format, bool mipmap); //  mipmap param
};