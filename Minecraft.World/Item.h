...
public:
	...
	enum
	{
		...
		eMaterial_diamond,
		eMaterial_cloth,
		eMaterial_chain, // It's available in creative in 1.8
		eMaterial_detector,
		eMaterial_lapis,
		eMaterial_music,
		eMaterial_dye,
...
protected:
	...
	static wstring ICON_DESCRIPTION_PREFIX; // Was const but we have to static initialise it outside of this class
...
public:
	...
	private:
		...
		// Had to make this public but was protected
...
public:
	...
	// this one isn't playable in the PC game, but is fine in ours
...
private:
	...
	// A value from strings.h, that is the name of the item
	unsigned int descriptionId;

	// A value from strings.h that says what this does
...
public:
	...
	virtual void appendHoverText(shared_ptr<ItemInstance> itemInstance, shared_ptr<Player> player, vector<wstring> *lines, bool advanced, vector<wstring> &unformattedStrings); //  unformattedStrings
