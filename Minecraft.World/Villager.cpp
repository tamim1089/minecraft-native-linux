...
int Villager::getTexture()
{
	...
	case PROFESSION_FARMER:
		return TN_MOB_VILLAGER_FARMER; //  "/mob/villager/farmer.png";
		break;
	case PROFESSION_LIBRARIAN:
		return TN_MOB_VILLAGER_LIBRARIAN; //  "/mob/villager/librarian.png";
		break;
	case PROFESSION_PRIEST:
		return TN_MOB_VILLAGER_PRIEST; //  "/mob/villager/priest.png";
		break;
	case PROFESSION_SMITH:
		return TN_MOB_VILLAGER_SMITH; //  "/mob/villager/smith.png";
		break;
	case PROFESSION_BUTCHER:
		return TN_MOB_VILLAGER_BUTCHER; //  "/mob/villager/butcher.png";
		break;
		//default:
		//	return TN_MOB_VILLAGER_VILLAGER; //  "/mob/villager/villager.png";
		//	break;
	}
...
{
	// added limit to villagers that can be bred
