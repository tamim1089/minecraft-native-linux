...
public:
	...
	static Stat* itemsSmelted(int itemId) { return instance->get_itemsSmelted(itemId); }	// Diffentiation needed, when only one type of event should be sent (eg iron smelting).
