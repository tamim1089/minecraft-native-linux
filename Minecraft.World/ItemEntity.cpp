...
void ItemEntity::tick()
{
	...
	// added parameter here so that these don't care about colliding with other entities
	move(xd, yd, zd, true);
...
{
	// added next line: found whilst debugging an issue with item entities getting into a bad state when being created by a cactus, since entities insides cactuses get hurt
