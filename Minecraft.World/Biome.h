...
public:
	...
	static const int BIOME_COUNT = 23; //  added
...
public:
	...
	virtual float getDownfall();			// brought forward from 1.2.3
	virtual float getTemperature();			// brought forward from 1.2.3
