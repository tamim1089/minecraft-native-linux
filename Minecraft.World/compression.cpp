...
#if defined _LINUX || defined _LINUX || defined _LINUX || defined __LP64__ || defined _LINUX
#include "../Minecraft.Client/Common/zlib/zlib.h"
#endif

#if defined _LINUX
#include "../Minecraft.Client/Linux/LinuxExtras/zlib.h"
#elif defined _LINUX
#include "../Minecraft.Client/Linux/PS3Extras/EdgeZLib.h"
#endif //_LINUX
...
HRESULT Compression::DecompressLZXRLE(void *pDestination, unsigned int *pDestSize, void *pSource, unsigned int SrcSize)
{
	...
	// Fix for #13676 - Crash: Crash while attempting to load a world after updating TU
	...
	// Changed this again to dynamically allocate a buffer if it's going to be too big
...
{
#if defined _LINUX || defined _LINUX || defined __LP64__ || defined _LINUX || defined _LINUX
...
// MGH -  same as VirtualDecompress in LinuxStubs, but for use on other platforms (so no virtual mem stuff)
#ifndef _LINUX
...
HRESULT Compression::DecompressWithType(void *pDestination, unsigned int *pDestSize, void *pSource, unsigned int SrcSize)
{
	...
	{
	case eCompressionType_RLE: // RLE is just that; don't want to break here though.
	...
	case eCompressionType_LZXRLE:
		{
#if (defined _LINUX || defined _LINUX || defined __LP64__ || defined _LINUX)
			SIZE_T destSize = (SIZE_T)(*pDestSize);
			HRESULT res = XMemDecompress(decompressionContext, pDestination, (SIZE_T *)&destSize, pSource, SrcSize);
			*pDestSize = (unsigned int)destSize;
			return res;
