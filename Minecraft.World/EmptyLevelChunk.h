...
public:
	...
	bool setData(int x, int y, int z, int val, int mask, bool *maskedBitsChanged);		//  mask
	...
	void load();
	void unload(bool unloadTileEntities) ;	// added parameter
	void markUnsaved();
	...
	int getBlocksAndData(byteArray data, int x0, int y0, int z0, int x1, int y1, int z1, int p, bool includeLighting = true);	// added includeLighting parameter
	int setBlocksAndData(byteArray data, int x0, int y0, int z0, int x1, int y1, int z1, int p, bool includeLighting = true);	// added includeLighting parameter
