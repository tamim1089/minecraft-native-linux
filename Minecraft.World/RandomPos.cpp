...
Vec3 *RandomPos::getPos(shared_ptr<PathfinderMob> mob, int xzDist, int yDist, int quadrant/*=-1*/)		// added quadrant
{
...
Vec3 *RandomPos::generateRandomPos(shared_ptr<PathfinderMob> mob, int xzDist, int yDist, Vec3 *dir, int quadrant/*=-1*/)		// added quadrant
{
	...
	// restrict is a reserved keyword
	bool bRestrict;
	...
	{
		int xt, yt, zt;
		// added quadrant here so that we can choose to select positions only within the one quadrant. Passing a parameter of -1 will
