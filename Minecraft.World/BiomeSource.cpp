...
// removal of separate temperature & downfall layers brought forward from 1.2.3
...
{	
	...
	// Moving forward plains as a spawnable biome (mainly for the Superflat world)
...
// note that caller is responsible for deleting returned array. temperatures array is for output only.
...
// caller is responsible for deleting biomes array
...
// find a seed for this biomesource that matches certain criteria
#ifdef _LINUX
...
// get the fractional amounts of each biome type in the given indices
...
// determine if this particular set of fractional amounts of biome types matches are requirements
