#pragma once
// this WeighedRandomItem class was a nested static class within WeighedRandom, but we need to be able to refer to it externally
...
{
public:
	// vectors here were Collection<? extends WeighedRandomItem>
