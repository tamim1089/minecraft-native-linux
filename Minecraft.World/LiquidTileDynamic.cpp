...
// Split off what was the tick function to be able to change between recursive and iterative ticking
...
{
	// don't try and spread out of our restricted map. If we don't do this check then tiles at the edge of the world will try and spread outside as the outside tiles report that they contain
