...
void Item::staticCtor()
{
	...
	// todo - add materials and base types to the ones below
	...
	// changing the cake to be stackable - Jens ok'ed this 23/10/12
	...
	// new records brought forward from 1.2.3
...
// We need to do this after the staticCtor AND after staticCtors for other class
// eg Recipes
