...
// Don't require bit 13 to be set. We don't use it in the creative menu. Side effect is you can make a (virtually useless) Splash Mundane potion with water bottle and gunpowder
...
#if _SIMPLIFIED_BREWING
// Trimmed this function to remove all the unused features for simplified brewing
...
int PotionBrewing::applyBrewBit(int currentBrew, int bit, bool isNeg, bool isNot, bool isRequired)
{
	if (isRequired)
	{
		// I wanted to be able to specify that a
