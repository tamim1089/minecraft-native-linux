...
LavaSlime::LavaSlime(Level *level) : Slime(level)
{
	...
	// The Slime ctor has already called this, and as we don't override it here don't need to call it
	...
	this->textureIdx = TN_MOB_LAVA; //  "/mob/lava.png";
	fireImmune = true;
	walkingSpeed = .2f;
}
...
{
	// brought forward the magma cream drops
