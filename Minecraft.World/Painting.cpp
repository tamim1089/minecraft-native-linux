...
// Rather than creating a new string object here I am just using the
...
Painting::Painting(Level *level, int xTile, int yTile, int zTile, int dir) : HangingEntity( level , xTile, yTile, zTile, dir)
{
	...
	// If you use this ctor, then you need to call the PaintingPostConstructor
}

// Added this so that we can use some shared_ptr functions that were needed in the ctor
