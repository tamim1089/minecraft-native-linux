...
class Node 
{
	// these classes were accessing protected members.
...
public:
	...
	Node() : hash(0),x(0),y(0),z(0) {}		// added default constructor so we can make an empty of array of these as a copy target
