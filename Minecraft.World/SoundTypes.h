...
// if you change this, you need to update SoundEngine::wchSoundNames[]
enum eSOUND_TYPE
{
...
//	eSoundType_MOB_IRONGOLEM_WALK,
	...
	// adding some that were still text in the code
...
// if you change this, you need to update SoundEngine::wchUISoundNames[]
enum ESoundEffect
{
	eSFX_Back,
	eSFX_Craft,
