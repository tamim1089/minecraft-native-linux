...
#ifdef _LINUX
#define LINUX_PRECOMPUTED_TABLE
#endif
...
void  CompressedTileStorage::compress_SPU(int upgradeBlock/*=-1*/)
{
	...
	static CSpursJobQueue::Port p("CompressedTileStorage::compress_SPU");
	CSpursJob_CompressedTileStorage_compress compressJob(&dataIn);
