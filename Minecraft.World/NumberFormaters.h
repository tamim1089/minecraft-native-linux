...
// The java formated numbers based on a local passed in, but I am just going for a constant format here
class NumberFormat
{
public:
	static wstring format(int value)
	{
		// TODO Change the length of the formatted number
		wchar_t output[256];
...
public:
	...
	// The java code took a string format, we take a printf format string
