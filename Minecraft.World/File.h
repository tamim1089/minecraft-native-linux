#pragma once
using namespace std;
// Represents java standard library class
...
public:
	...
	const wstring getPath() const; // TODO
...
private:
	...
	// just helper functions, change between paths and vector<string>
