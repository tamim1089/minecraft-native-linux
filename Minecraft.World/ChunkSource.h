...
#ifdef _LARGE_WORLDS
// Our default map (at zoom level 3) is 1024x1024 blocks (or 64 chunks)
...
// Fix the size of the end for all platforms
// 54 / 3 = 18
...
{
public:
	//  so that we can store the maximum dimensions of this world
	int m_XZSize;
...
public:
	...
	virtual bool reallyHasChunk(int x, int y) { return hasChunk(x,y); }	// 
