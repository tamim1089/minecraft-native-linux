...
Ghast::Ghast(Level *level) : FlyingMob( level )
{
    ...
    this->textureIdx = TN_MOB_GHAST; //  L"/mob/ghast.png";
    this->setSize(4, 4);
...
//    this->textureName = current == 1 ? L"/mob/ghast_fire.png" : L"/mob/ghast.png";	//  with following line
...
{
    return 0.4f;//10; changing due to customer demands
}
