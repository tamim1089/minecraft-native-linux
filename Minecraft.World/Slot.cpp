...
bool Slot::mayCombine(shared_ptr<ItemInstance> second)
{
	...
	// This condition taken from Recipes::getItemFor to repair items, but added the damaged check to skip when the result is pointless
	...
	{
		// Don't allow combinining enchanted items, the enchantment will be lost. They can use the anvil for this
