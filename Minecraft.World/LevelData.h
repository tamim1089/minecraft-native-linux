...
protected:
	virtual void setTagData(CompoundTag *tag);		// removed  CompoundTag *playerTag
...
public:
    ...
    //int getDimension(); //  TU 9 as it's never accurate
    ...
    //void setDimension(int dimension); //  TU 9 as it's never used
