...
void VineTile::updateShape(LevelSource *level, int x, int y, int z, int forceData, shared_ptr<TileEntity> forceEntity) //  forceData, forceEntity param
{
...
void VineTile::tick(Level *level, int x, int y, int z, Random *random)
{
    if (!level->isClientSide)
	{
		...
		{
			// Brought side spread check forward from 1.2.3
			int r = 4;
			int max = 5;
