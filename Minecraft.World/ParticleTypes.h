...
//  added to avoid string compares on adding particles
enum ePARTICLE_TYPE
{
	eParticleType_bubble,
	eParticleType_smoke,
	eParticleType_note,
	eParticleType_netherportal, // This particle should only be used by the Nether portal. Everything else should use eParticleType_end
	eParticleType_endportal, // Seperated this from torches and fires
	...
	eParticleType_ender, // These are things that used the "portal" particle but are actually end related entities
	eParticleType_angryVillager,
	eParticleType_happyVillager,

	// In the java, the particle name was used to sneak parameters in for the Terrain and IconCrack particle constructors.
