...
private:
	...
	// added to replace use of Class<? extends StrongholdPiece> within this class
	enum EPieceClass
	{
		EPieceClass_NULL,
	...
	{
	public:
		EPieceClass pieceClass;		// was Class<? extends StrongholdPiece>
		const int weight;
		int placeCount;
		int maxPlaceCount;
	...
	// added, java uses a local specialisation of these classes when instancing to achieve the same thing
...
public:
	...
	public:
        ...
        StartPiece(int genDepth, Random *random, int west, int north, Level *level); //  level param
