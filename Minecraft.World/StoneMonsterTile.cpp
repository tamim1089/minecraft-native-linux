...
void StoneMonsterTile::destroy(Level *level, int x, int y, int z, int data)
{
	...
	{
		// limit total amount of monsters. The normal map spawning limits these to 50, and mobspawning tiles limit to 60, so give ourselves a bit of headroom here to also be able to make silverfish
