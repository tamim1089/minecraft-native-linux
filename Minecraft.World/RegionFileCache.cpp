...
RegionFile *RegionFileCache::_getRegionFile(ConsoleSaveFile *saveFile, const wstring &prefix, int chunkX, int chunkZ)		// TODO was synchronized
{
	// changed back to use of the File class.
	...
	*/
    ...
    cache[file] = reg;	   // this was originally a softReferenc
    return reg;

}

void RegionFileCache::_clear()															// TODO was synchronized
{
