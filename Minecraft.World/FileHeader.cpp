...
void FileHeader::WriteHeader( LPVOID saveMem )
{
	...
	//  for save version 2 to be the number of files rather than the size in bytes
...
void FileHeader::ReadHeader( LPVOID saveMem, ESavePlatform plat /*= SAVE_FILE_PLATFORM_LOCAL */  )
{
	...
	//case 8: // SAVE_FILE_VERSION_NUMBER 2,3,4,5,6,7,8 are the same, but:
	...
	case SAVE_FILE_VERSION_LINUX_CHANGE_MAP_DATA_MAPPING_SIZE:
	...
	// At time of writing, the tutorial save is V1 so need to keep this for compatibility
