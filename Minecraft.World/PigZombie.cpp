...
PigZombie::PigZombie(Level *level) : Zombie( level )
{
	...
	// Zombie has already called this, and we don't override it so the Zombie one is the most derived version anyway
    ...
    this->textureIdx = TN_MOB_PIGZOMBIE; //  L"/mob/pigzombie.png";
    runSpeed = 0.5f;
    attackDamage = 5;
...
{
	// TODO could be of const shared_ptr<ItemInstance>  type.
