...
{
public:
	//  so we can add a priority write function
...
private:
	...
	public:
		...
		virtual void close();
		virtual __int64 skip(__int64 n) { return n; } // Not implemented
		virtual void flush() {}
	};
...
public:	
	CThread::Event* m_socketClosedEvent;
...
public:
	...
	Socket(bool response = false);								// Create a local socket, for end 0 or 1 of a connection
	Socket(INetworkPlayer *player, bool response  = false, bool hostLocal = false);		// Create a socket for an INetworkPlayer
