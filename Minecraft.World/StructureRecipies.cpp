...
void StructureRecipies::addRecipes(Recipes *r) 
{
	...
	// Changed the order, as the blocks that go with sandstone cause a 3-icon scroll
	...
	// Move this into "Recipes" to change the order things are displayed on the crafting menu
