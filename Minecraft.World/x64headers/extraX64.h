...
#include "../../Minecraft.Client/Linux/Orbis_PlayerUID.h"
...
#include <assert.h>
#include <stdlib.h>
#include "../../Minecraft.Client/Linux/PS3_PlayerUID.h"
#include "../../Minecraft.Client/Linux/Network/SQRNetworkManager.h"
typedef SQRNetworkManager::SessionID SessionID;
typedef SQRNetworkManager::PresenceSyncInfo INVITE_INFO;
...
#include <assert.h>
#include <stdlib.h>
#include "../../Minecraft.Client/Linux/Linux_PlayerUID.h"
#include "../../Minecraft.Client/Linux/Network/SQRNetworkManager_Vita.h"
#include "../../Minecraft.Client/Linux/Network/SQRNetworkManager_AdHoc_Vita.h"
...
#include "../../Minecraft.Client/Linux/Network/DQRNetworkManager.h"
...
typedef struct _XONLINE_FRIEND {
    PlayerUID uid;
    CHAR szUsername[MAX_USERNAME_SIZE];
    DWORD dwFriendState;
    SessionID sessionID;
    DWORD dwTitleID;
    FILETIME ftUserTime;
...
public:
	...
	IQNetPlayer *GetPlayerByUid(PlayerUID uid);
...
#define INVALID_UID PlayerUID()
#else
const int INVALID_UID = 0;
#endif
...
#define XUSER_GET_SIGNIN_INFO_ONLINE_UID_ONLY      0x00000001
#define XUSER_GET_SIGNIN_INFO_OFFLINE_UID_ONLY     0x00000002
