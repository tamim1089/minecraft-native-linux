...
#include "WebMaterial.h"// Java version just does a local alteration when instantiating the Material for webs to get the same thing
...
void Material::staticCtor()
{
	...
	//  WebMaterial, Java version just does a local alteration when instantiating the Material for webs to get the same thing
