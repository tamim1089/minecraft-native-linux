...
{
private:
	//  so we can have separate storage arrays for different threads
	class ThreadStorage
	{
	public:
		byteArray blockData;
...
public:
	...
	static bool saveEntities(LevelChunk *lc, Level *level, CompoundTag *tag); // 
	static void save(LevelChunk *lc, Level *level, DataOutputStream *dos); // 
