...
{
	// TODO I am not entirely sure if this matches the implementation of the Java library
	// TODO Need to handle exceptions here is we throw them in other InputStreams
...
wstring DataInputStream::readUTF()
{
	...
	//// I decided while writing DataOutputStream that we didn't need to bother using the UTF8 format
