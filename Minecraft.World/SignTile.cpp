...
void SignTile::updateShape(LevelSource *level, int x, int y, int z, int forceData, shared_ptr<TileEntity> forceEntity) //  forceData, forceEntity param
{
	if (onGround) return;
...
{
	//try {
	// For some reason the newInstance wasn't working right, but doing it like the other TileEntities is fine
