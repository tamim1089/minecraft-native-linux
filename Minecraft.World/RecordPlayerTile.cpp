...
bool RecordPlayerTile::use(Level *level, int x, int y, int z, shared_ptr<Player> player, int clickedFace, float clickX, float clickY, float clickZ, bool soundOnly/*=false*/) //  soundOnly param
{
...
void RecordPlayerTile::dropRecording(Level *level, int x, int y, int z)
{
	...
	// the level event will play the music
