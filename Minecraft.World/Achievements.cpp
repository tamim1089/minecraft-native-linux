...
int Achievements::xMin = 4294967295; //  Was 4294967296 which is 1 larger than maxint. Hopefully no side effects
int Achievements::yMin = 4294967295; //  Was 4294967296 which is 1 larger than maxint. Hopefully no side effects
...
void Achievements::staticCtor()
{
	...
	// The order of these achievemnts is very important, as they map directly to data stored in the profile data. New achievements should be added at the end.
...
// These stats (achievements) are directly followed by new stats/achievements in the profile data, so cannot be changed without migrating the profile data
	...
	// All new Java achievements removed to stop them using the profile data
