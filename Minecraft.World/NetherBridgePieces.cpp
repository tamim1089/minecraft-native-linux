...
NetherBridgePieces::PieceWeight *NetherBridgePieces::bridgePieceWeights[NetherBridgePieces::BRIDGE_PIECEWEIGHTS_COUNT] =
{
	...
	new PieceWeight(EPieceClass_MonsterThrone, 15, 2), // Increased weight to ensure that we have these (was 5), required for Blazes and therefore required for brewing
	new PieceWeight(EPieceClass_CastleEntrance, 15, 1), // Increased weight to ensure that we have these (was 5), required for CastleStalkRoom, and therefore required for brewing
...
{
	new PieceWeight(EPieceClass_CastleStalkRoom, 30, 2), // Increased weight to ensure that we have these (was 5), required for Nether Wart, and therefore required for brewing
