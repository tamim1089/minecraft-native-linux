...
public:
	...
	public:
		...
		MapDecoration(char img, char x, char y, char rot, int entityId, bool visible); //  entityId, visible param
	};
	...
	public:
		// Had to add a reference to the MapItemSavedData object that created us as we try to access it's member variables
