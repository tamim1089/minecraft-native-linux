	...
	public:
        ...
        virtual void load(CompoundTag *tag)
		{
         ...
         virtual void save(CompoundTag *tag)
		 {
			...
			// return true;	// TODO, in java there is no return type here but we can't change our derived class member function to not have one - investigate
			// took out the return statement, TileEntity::save is now virtual. Think this fixes above.
        }
