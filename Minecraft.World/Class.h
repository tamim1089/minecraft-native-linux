...
// This Enum can be used as a more lightweight version of the above, without having do dynamic casts
// for replacement of instanceof
enum eINSTANCEOF
{
	eTYPE_NOTSET=0,

	//  arranging these pathfinder types in a bitfield fashion so that a single and can determine whether they are derived from
	...
	// These have the ANIMAL, AGABLE_MOB and ANIMALS_SPAWN_LIMIT_CHECK bits set
	eTYPE_COW         = 0x82201,
	eTYPE_SHEEP       = 0x82202,
	eTYPE_PIG         = 0x82203,
	...
	// When adding new categories, please also update ConsoleSchematicFile::generateSchematicFile so these can be saved out to schematics
	// These have the ANIMAL and AGABLE_MOB bits set, but NOT ANIMALS_SPAWN_LIMIT_CHECK 
	eTYPE_CHICKEN     = 0x2206,
	eTYPE_WOLF        = 0x2207,
	eTYPE_MUSHROOMCOW = 0x2208,

	// If you add new hostile mobs here you should also update the string lookup function at CConsoleMinecraftApp::getEntityName
	eTYPE_MONSTER     = 0x400,
	eTYPE_ENEMY       = 0x800,
	eTYPE_CREEPER     = 0xC01,
	eTYPE_GIANT       = 0xC02,
