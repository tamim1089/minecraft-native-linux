...
{
	// I've added ã in (for Portuguese in bed string) and added the character at the same place in the default.png font
...
#if 0 // do we actually really need to get this from a file?
	//try {
