...
public:
	...
	// Added these to fix problem with items picked up while in the creative menu replacing slots in the creative menu
...
public:
	...
	virtual void slotsChanged();//  to take a shared_ptr<Container> container but wasn't using it, so removed to simplify things
	bool isPauseScreen();
...
protected:
	// Changes to return bool brought forward from 1.2
