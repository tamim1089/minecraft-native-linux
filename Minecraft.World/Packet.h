...
public:
	...
	// Added the sendToAnyClient param so we can limit some packets to be only sent to one player on a system
	// Added renderStats param for use in debugging
...
private:
	//  to track stats for packets that are going out via QNet
...
public:
	...
	virtual void read(DataInputStream *dis) = 0; // throws IOException = 0; TODO should this declare a throws?
	virtual void write(DataOutputStream *dos) = 0; // throws IOException = 0; TODO should this declare a throws?
